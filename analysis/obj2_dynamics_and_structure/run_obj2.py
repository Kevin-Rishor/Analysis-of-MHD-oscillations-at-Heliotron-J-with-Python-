...
def main():
    ...
    scripts = [
        ...
        ("2. Secondary Mode Band (40 - 80 kHz): Heating Sync & Structure",
         [sys.executable, str(current / "mhd_analysis_obj2.py"), "--shots", "88653", "--fmin", "40", "--fmax", "80"]),
        ("3. Primary Mode Band (80 - 120 kHz): Heating Sync & Structure",
         [sys.executable, str(current / "mhd_analysis_obj2.py"), "--shots", "88653", "--fmin", "80", "--fmax", "120"]),
